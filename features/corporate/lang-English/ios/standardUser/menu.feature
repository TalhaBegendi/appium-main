...
Feature: Menu Language English
  ...
  Scenario: Go to Corporate from Menu
    When Go to "Corporate" from Menu

  Scenario: Go to POS from Menu
  ...
  Scenario: Go to E-Government from Menu
    When Go to "E-Government" from Menu
  ...
  Scenario: Go to My Forward Transactions from Currency / Precious Metals Menu
    When Go to "Currency / Precious Metals > My Forward Transactions" from Menu with assertion "UPDATE_TRANSACTIONS_LIMIT_MENU_ITEM" of type "EQUAL" using "NAME"
  ...
  Scenario: Go to Application Letter of Guarantee on Financing from Menu
    When Go to "Financing > Letter of Guarantee > Application Letter of Guarantee" from Menu with assertion "LETTER_OF_GUARANTEE_MENU_ITEM" of type "EQUAL" using "TEXT"

  Scenario: Go to Letter of Guarantee Application Tracking on Financing from Menu
    When Go to "Financing > Letter of Guarantee > Letter of Guarantee Application Tracking" from Menu with assertion "LETTER_OF_GUARANTEE_MENU_ITEM" of type "EQUAL" using "TEXT"

  Scenario: Go to Financing Limit and Risk Information on Cards from Menu
    When Go to "Financing > Financing Limit and Risk Information" from Menu with assertion "FINANCING_LIMIT_AND_RISK_INFORMATION" of type "EQUAL" using "TEXT"
  ...
  Scenario: Investment > My Orders
    When Go to "Investment > My Orders" from Menu with assertion "MY_INVESTMENT_ACCOUNTS_MENU_TITLE" of type "EQUAL" using "NAME"
  ...
  Scenario: Corporate > Transactions
    When Go to "Corporate > Transactions" from Menu with assertion "CORPORATE_TITLE_MENU_ITEM" of type "EQUAL" using "TEXT"

  Scenario: Corporate > User Management
    When Go to "Corporate > User Management" from Menu with assertion "CORPORATE_TITLE_MENU_ITEM" of type "EQUAL" using "TEXT"

  Scenario: Corporate > Approval Group
    When Go to "Corporate > Approval Group" from Menu with assertion "CORPORATE_TITLE_MENU_ITEM" of type "EQUAL" using "TEXT"

  Scenario: POS > POS Terms of Use
    When Go to "POS > POS Terms of Use" from Menu with assertion "POS_TITLE_MENU_ITEM" of type "EQUAL" using "TEXT"

  Scenario: POS > My POS Application
    When Go to "POS > My POS Application" from Menu with assertion "POS_TITLE_MENU_ITEM" of type "EQUAL" using "TEXT"

  Scenario: POS > POS Transactions
    When Go to "POS > POS Transactions" from Menu with assertion "POS_TITLE_MENU_ITEM" of type "EQUAL" using "TEXT"
  ...
  Scenario: Settings > Language Settings
    When Go to "Settings > Language Settings" from Menu with assertion "SETTINGS_MENU_ITEM" of type "EQUAL" using "TEXT"

  Scenario: Settings > Permission Preferences > Information Sharing Options
    When Go to "Settings > Permission Preferences > Information Sharing Options" from Menu with assertion "SETTINGS_MENU_ITEM" of type "EQUAL" using "TEXT"

  Scenario: Settings > Security Settings > Login Registrations
    When Go to "Settings > Security Settings > Login Registrations" from Menu with assertion "SETTINGS_MENU_ITEM" of type "EQUAL" using "TEXT"

  Scenario: Settings > Password Settings > Unblock SIM Card
    When Go to "Settings > Password Settings > Unblock SIM Card" from Menu with assertion "SETTINGS_MENU_ITEM" of type "EQUAL" using "TEXT"

  Scenario: Settings > Password Settings > Biometric Verification
    When Go to "Settings > Password Settings > Biometric Verification" from Menu with assertion "SETTINGS_MENU_ITEM" of type "EQUAL" using "TEXT"

  Scenario: Settings > Profile Info > Corporate Profile
    When Go to "Settings > Profile Info > Corporate Profile" from Menu with assertion "SETTINGS_MENU_ITEM" of type "EQUAL" using "TEXT"

  Scenario: Settings > Profile Info > My Profile
    When Go to "Settings > Profile Info > My Profile" from Menu with assertion "SETTINGS_MENU_ITEM" of type "EQUAL" using "TEXT"

  Scenario: Settings > Notification Settings
    When Go to "Settings > Notification Settings" from Menu with assertion "SETTINGS_MENU_ITEM" of type "EQUAL" using "TEXT"

  Scenario: Settings > Open Banking Settings > Open Banking Channel
    When Go to "Settings > Open Banking Settings > Open Banking Channel" from Menu with assertion "SETTINGS_MENU_ITEM" of type "EQUAL" using "TEXT"

  Scenario: Settings > Open Banking Settings > My Open Banking Permissions
    When Go to "Settings > Open Banking Settings > My Open Banking Permissions" from Menu with assertion "SETTINGS_MENU_ITEM" of type "EQUAL" using "TEXT"

  Scenario: Settings > Payment Request Preferences
    When Go to "Settings > Payment Request Preferences" from Menu with assertion "SETTINGS_MENU_ITEM" of type "EQUAL" using "TEXT"

  Scenario: Applications > Card Application
    When Go to "Applications > Card Application" from Menu with assertion "ACCOUNTS_TITLE_MENU" of type "EQUAL" using "TEXT"

  Scenario: Applications > Application Letter Of Reference > Application Letter Of Reference
    When Go to "Applications > Application Letter Of Reference > Application Letter Of Reference" from Menu with assertion "ACCOUNTS_TITLE_MENU" of type "EQUAL" using "TEXT"

  Scenario: Applications > Application Letter Of Reference > Letter Of Reference List
    When Go to "Applications > Application Letter Of Reference > Letter Of Reference List" from Menu with assertion "ACCOUNTS_TITLE_MENU" of type "EQUAL" using "TEXT"

  Scenario: Applications > Letter of Guarantee > Application Letter of Guarantee
    When Go to "Applications > Letter of Guarantee > Application Letter of Guarantee" from Menu with assertion "ACCOUNTS_TITLE_MENU" of type "EQUAL" using "TEXT"

  Scenario: Applications > Letter of Guarantee > Letter of Guarantee Application Tracking
    When Go to "Applications > Letter of Guarantee > Letter of Guarantee Application Tracking" from Menu with assertion "ACCOUNTS_TITLE_MENU" of type "EQUAL" using "TEXT"

  Scenario: Applications > My Card Applications
    When Go to "Applications > My Card Applications" from Menu with assertion "ACCOUNTS_TITLE_MENU" of type "EQUAL" using "TEXT"
