...
Feature: Menu Language Turkish - ANDROID - CORPORATE
  ...
  Scenario: CORPORATE - Hesaplar > Favori IBAN
    When Go to "Hesaplar > Favori IBAN" from Menu

  Scenario: CORPORATE - Hesaplar > Kolay Adreslerim
    When Go to "Hesaplar > Kolay Adreslerim" from Menu
  ...
  Scenario: CORPORATE - Kartlar > Kart Başvurularım
    When Go to "Kartlar > Kart Başvurularım" from Menu

  Scenario: CORPORATE - Kartlar > Harcama İtirazı
    When Go to "Kartlar > Harcama İtirazı" from Menu

  Scenario: CORPORATE - Kartlar > Borç Öde > Kendi Kartıma
    When Go to "Kartlar > Borç Öde > Kendi Kartıma" from Menu

  Scenario: CORPORATE - Kartlar > Borç Öde > Başka Karta
    When Go to "Kartlar > Borç Öde > Başka Karta" from Menu

  Scenario: CORPORATE - Para Transferi > Son İşlemler
    When Go to "Para Transferi > Son İşlemler" from Menu

  Scenario: CORPORATE - Para Transferi > Hesaplarım Arası
    When Go to "Para Transferi > Hesaplarım Arası" from Menu

  Scenario: CORPORATE - Para Transferi > Kayıtlı Para Transferleri
    When Go to "Para Transferi > Kayıtlı Para Transferleri" from Menu

  Scenario: CORPORATE - Para Transferi > Başka Hesaba > IBAN
    When Go to "Para Transferi > Başka Hesaba (Havale / EFT / FAST) > IBAN" from Menu

  Scenario: CORPORATE - Para Transferi > Başka Hesaba > Hesap
    When Go to "Para Transferi > Başka Hesaba (Havale / EFT / FAST) > Hesap" from Menu

  Scenario: CORPORATE - Para Transferi > Başka Hesaba > Telefon No
    When Go to "Para Transferi > Başka Hesaba (Havale / EFT / FAST) > Telefon No" from Menu
  ...
  Scenario: CORPORATE - Para Transferi > Döviz Transferlerim
    When Go to "Para Transferi > Döviz Transferi > Döviz Transferlerim" from Menu

  Scenario: CORPORATE - Para Transferi > Para Transferi Talimatlarım
    When Go to "Para Transferi > Para Transferi Talimatlarım" from Menu

  Scenario: CORPORATE - Karekod İşlemleri > ATM'den Para Çek
    When Go to "Karekod İşlemleri > ATM'den Para Çek" from Menu

  Scenario: CORPORATE - Karekod İşlemleri > ATM'den Para Yatır
    When Go to "Karekod İşlemleri > ATM'den Para Yatır" from Menu

  Scenario: CORPORATE - Karekod İşlemleri > Karekod İle Öde
    When Go to "Karekod İşlemleri > Karekod İle Öde" from Menu

  Scenario: CORPORATE - Karekod İşlemleri > Ödeme Al
    When Go to "Karekod İşlemleri > Ödeme Al" from Menu
  ...
  Scenario: CORPORATE - Döviz / Kıymetli Maden > Emirlerim
    When Go to "Döviz / Kıymetli Maden > Emirlerim" from Menu

  Scenario: CORPORATE - Döviz / Kıymetli Maden > İşlemlerim
    When Go to "Döviz / Kıymetli Maden > İşlemlerim" from Menu

  Scenario: CORPORATE - Döviz / Kıymetli Maden > Kur Referansı İşlemleri
    When Go to "Döviz / Kıymetli Maden > Kur Referansı İşlemleri" from Menu

  Scenario: CORPORATE - Döviz / Kıymetli Maden > Forward İşlemlerim
    When Go to "Döviz / Kıymetli Maden > Forward İşlemlerim" from Menu

  Scenario: CORPORATE - Finansman > Finansmanlarım
    When Go to "Finansman > Finansmanlarım" from Menu

  Scenario: CORPORATE - Finansman > Finansman Taksit Öde
    When Go to "Finansman > Finansman Taksit Öde" from Menu

  Scenario: CORPORATE - Finansman > Teminat Mektubu > Teminat Mektubu Başvurusu
    When Go to "Finansman > Teminat Mektubu > Teminat Mektubu Başvurusu" from Menu

  Scenario: CORPORATE - Finansman > Teminat Mektubu > Teminat Mektubu Başvuru İzleme
    When Go to "Finansman > Teminat Mektubu > Teminat Mektubu Başvuru İzleme" from Menu

  Scenario: CORPORATE - Finansman > Finansman Limit ve Risk Bilgileri
    When Go to "Finansman > Finansman Limit ve Risk Bilgileri" from Menu

  Scenario: CORPORATE - Yatırım > Portföyüm
    When Go to "Yatırım > Portföyüm" from Menu

  Scenario: CORPORATE - Yatırım > Alış / Satış
    When Go to "Yatırım > Alış / Satış (Hisse / Fon / Kira S.)" from Menu

  Scenario: CORPORATE - Yatırım > İşlemlerim
    When Go to "Yatırım > İşlemlerim" from Menu

  Scenario: CORPORATE - Yatırım > Emirlerim
    When Go to "Yatırım > Emirlerim" from Menu

  Scenario: CORPORATE - Yatırım > Yatırım Hesaplarım
    When Go to "Yatırım > Yatırım Hesaplarım" from Menu

  Scenario: CORPORATE - Yatırım > Uygunluk Testi
    When Go to "Yatırım > Uygunluk Testi" from Menu

  Scenario: CORPORATE - Çek - Senet > Çek İşlemleri > Çeklerim
    When Go to "Çek - Senet > Çek İşlemleri > Çeklerim" from Menu

  Scenario: CORPORATE - Çek - Senet > Çek İşlemleri > Çek Defterlerim
    When Go to "Çek - Senet > Çek İşlemleri > Çek Defterlerim" from Menu

  Scenario: CORPORATE - Çek - Senet > Çek İşlemleri > Çek Defter Başvurularım
    When Go to "Çek - Senet > Çek İşlemleri > Çek Defter Başvurularım" from Menu

  Scenario: CORPORATE - Kurumsal > İşlemler
    When Go to "Kurumsal > İşlemler" from Menu

  Scenario: CORPORATE - Kurumsal > Kullanıcı Yönetimi
    When Go to "Kurumsal > Kullanıcı Yönetimi" from Menu

  Scenario: CORPORATE - Kurumsal > Onay Grubu
    When Go to "Kurumsal > Onay Grubu" from Menu

  Scenario: CORPORATE - POS > POS Çalışma Koşulları
    When Go to "POS > POS Çalışma Koşulları" from Menu

  Scenario: CORPORATE - POS > POS Başvurularım
    When Go to "POS > POS Başvurularım" from Menu

  Scenario: CORPORATE - POS > POS Hareketleri
    When Go to "POS > POS Hareketleri" from Menu

  Scenario: CORPORATE - Belgeler > Belgelerim
    When Go to "Belgeler > Belgelerim" from Menu

  Scenario: CORPORATE - Ayarlar > Dil Seçenekleri
    When Go to "Ayarlar > Dil Seçenekleri" from Menu
  ...
  Scenario: CORPORATE - Başvurular > Teminat Mektubu > Teminat Mektubu Başvurusu
    When Go to "Başvurular > Teminat Mektubu > Teminat Mektubu Başvurusu" from Menu

  Scenario: CORPORATE - Başvurular > Teminat Mektubu > Teminat Mektubu Başvuru İzleme
    When Go to "Başvurular > Teminat Mektubu > Teminat Mektubu Başvuru İzleme" from Menu

  Scenario: CORPORATE - Başvurular > Referans Mektubu Başvurusu > Referans Mektubu Başvuru
    When Go to "Başvurular > Referans Mektubu Başvurusu > Referans Mektubu Başvuru" from Menu

  Scenario: CORPORATE - Başvurular > Referans Mektubu > Referans Mektubu Başvuru İzleme
    When Go to "Başvurular > Referans Mektubu Başvurusu > Referans Mektubu Başvuru İzleme" from Menu
