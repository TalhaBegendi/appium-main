...
final class SavedTransactionsText {
    ...
    static final String FUND_CUSTOMER_RECEIVER_IBAN = "TR560021400000000129600002";
    static final String FUND_ACCOUNT_NUMBER = "1296";
    static final String FUND_ACCOUNT_NUMBER_SUFFIX = "4";
    ...
    static final String TURKISH_FUND_IBAN_ERROR_MESSAGE = "Girdiğiniz IBAN size aittir. Kontrol ederek, tekrar deneyiniz.";
